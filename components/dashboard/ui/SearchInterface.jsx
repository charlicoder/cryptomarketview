  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className={`relative transition-all duration-150 ${isFocused ? 'ring-2 ring-accent ring-offset-2 ring-offset-background' : ''
          }`}>
          <Icon
            name="Search"
            size={18}
          ...
          {showFilters && (
            <Button
              ...
              className={`absolute right-2 top-1/2 transform -translate-y-1/2 w-8 h-8 ${isFiltersOpen ? 'bg-accent text-accent-foreground' : 'hover:bg-muted/50'
                }`}
